	...
	<div class="pcoded-inner-navbar main-menu">
		<div class="">
			<div class="main-menu-header">
				...
				<c:if test="${usuarioImg != '' && usuarioImg != null}">
					<img class="img-80 img-radius" src="${usuarioImg}" alt="User-Profile-Image">
				</c:if>
				<c:if test="${usuarioImg == '' || usuarioImg == null}">
			...
			<div class="main-menu-content">
				<ul>
					<li class="more-details">
						...
						<a href="<%= request.getContextPath() %>/ServletLogin?action=logout"><i class="ti-layout-sidebar-left"></i>Sair</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<ul class="pcoded-item pcoded-left-item">
			...
			<li class="pcoded-hasmenu"><a href="javascript:void(0)"
				...
				<c:if test="${isAdmin}"> <!-- apenas admin podem acessar c:if, retorna boolean -->
					<li class=" "><a href="<%= request.getContextPath() %>/ServletUsuario?act=listUser"
						class="waves-effect waves-dark"> <span class="pcoded-micon"><i
